...
const tag = `[${(0, chalk_1.green)('@nativescript/webpack')}]`;
function error(message) {
    console.error(`${tag} ${(0, chalk_1.redBright)((0, ts_dedent_1.default)(message))}`);
}
function info(message) {
    console.info(`${tag} ${(0, chalk_1.greenBright)((0, ts_dedent_1.default)(message))}`);
}
...
commander_1.program
    ...
    (_a = env['watch']) !== null && _a !== void 0 ? _a : (env['watch'] = options.watch);
    ...
    (_b = (_d = process.env).NATIVESCRIPT_CONFIG_NAME) !== null && _b !== void 0 ? _b : (_d.NATIVESCRIPT_CONFIG_NAME = env['config']);
    const configPath = (() => {
        if (options.config) {
        ...
        if (stats) {
            ...
            if (configuration.profile || env.profile) {
                console.log([
                    '',
                    '|',
                    `|  The build profile has been written to ${(0, chalk_1.yellow)('webpack.stats.json')}`,
                    `|  You can analyse the stats at ${(0, chalk_1.green)('https://webpack.github.io/analyse/')}`,
                    '|',
                    '',
                ].join('\n'));
    ...
    if (options.watch) {
        ...
        compiler.watch((_c = configuration.watchOptions) !== null && _c !== void 0 ? _c : {}, webpackCompilationCallback);
    }
    else {
