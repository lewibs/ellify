...
(function (ios) {
    function createBackgroundUIColor(view, callback, flip) {
        ...
        if (background.clearFlags & 2 /* CLEAR_BOX_SHADOW */) {
...
function drawBoxShadow(nativeView, view, boxShadow, background, useSubLayer = false) {
    ...
    if (!((_a = background.color) === null || _a === void 0 ? void 0 : _a.a)) {
        // add white background if view has a transparent background
        layer.backgroundColor = UIColor.whiteColor.CGColor;
    }
    // shadow opacity is handled on the shadow's color instance
    layer.shadowOpacity = ((_b = boxShadow.color) === null || _b === void 0 ? void 0 : _b.a) ? ((_c = boxShadow.color) === null || _c === void 0 ? void 0 : _c.a) / 255 : 1;
