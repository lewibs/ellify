...
export class Frame extends FrameBase {
    ...
    setCurrent(entry, navigationType) {
        ...
        if ((entry === null || entry === void 0 ? void 0 : entry.resolvedPage) && currentEntryChanged) {
    ...
    _navigateCore(backstackEntry) {
        ...
        if (!animated && majorVersion > 10) {
            ...
            const barButtonItem = UIBarButtonItem.alloc().initWithTitleStyleTargetAction('', 0 /* Plain */, null, null);
    ...
    _updateActionBar(page, disableNavBarAnimation = false) {
        ...
        if ((_a = this._ios.controller) === null || _a === void 0 ? void 0 : _a.navigationBar) {
...
var UINavigationControllerImpl = /** @class */ (function (_super) {
    ...
    Object.defineProperty(UINavigationControllerImpl.prototype, "owner", {
        get: function () {
            var _a, _b;
            return (_b = (_a = this._owner).get) === null || _b === void 0 ? void 0 : _b.call(_a);
        },
        enumerable: true,
        configurable: true
    });
    UINavigationControllerImpl.prototype.viewWillAppear = function (animated) {
        ...
        var owner = (_b = (_a = this._owner).get) === null || _b === void 0 ? void 0 : _b.call(_a);
