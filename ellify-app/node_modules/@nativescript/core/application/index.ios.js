    ...
    const adjustRefreshRate = function () {
        ...
        if (displayedLink) {
            ...
            if (minFrameRateDisabled) {
                let max = 120;
                const deviceMaxFrames = (_a = UIScreen.mainScreen) === null || _a === void 0 ? void 0 : _a.maximumFramesPerSecond;
                ...
                if (iOSNativeHelper.MajorVersion >= 15) {
                    const min = (options === null || options === void 0 ? void 0 : options.min) || max / 2;
                    const preferred = (options === null || options === void 0 ? void 0 : options.preferred) || max;
