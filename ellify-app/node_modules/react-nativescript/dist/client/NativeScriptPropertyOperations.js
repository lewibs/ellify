 ...
 * @param {*} value
 */
export function setValueForProperty(instance, name, value, isCustomComponentTag, hostContext) {
    ...
    else if ((name.length > 2 && name.startsWith("on") && value === rnsDeletedPropValue) ||
