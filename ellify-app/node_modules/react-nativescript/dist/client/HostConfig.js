...
const noTimeoutValue = undefined;
...
const hostConfig = {
    ...
    getChildHostContext(parentHostContext, type, rootContainerInstance) {
        ...
        const prevIsInAParentSpan = parentHostContext.isInAParentSpan;
        const prevIsInAParentFormattedString = parentHostContext.isInAParentFormattedString;
        const prevIsInADockLayout = parentHostContext.isInADockLayout;
        const prevIsInAnAbsoluteLayout = parentHostContext.isInAnAbsoluteLayout;
        const prevIsInAFlexboxLayout = parentHostContext.isInAFlexboxLayout;
        /**
         ...
         */
        const isInAParentText = type === "label" || type === "textView" || type === "textField" || type === "button";
        /**
         ...
         */
        const isInAParentSpan = type === "span";
        const isInAParentFormattedString = type === "formattedString";
        const isInADockLayout = type === "dockLayout";
        const isInAGridLayout = type === "gridLayout";
        const isInAnAbsoluteLayout = type === "absoluteLayout";
        const isInAFlexboxLayout = type === "flexboxLayout";
    ...
    createInstance(type, props, rootContainerInstance, hostContext, internalInstanceHandle) {
        ...
        if (typeof type === "string" && isKnownView(type)) {
            ...
            const componentFunction = new type(props);
            const createdElement = componentFunction.render();
    ...
    prepareUpdate(instance, type, oldProps, newProps, rootContainerInstance, hostContext) {
        ...
        // })();
        const diffed = diffProperties(instance, type, oldProps, newProps, rootContainerInstance);
