/**
 * Code in here referenced from: https://github.com/facebook/react/blob/master/packages/react-dom/src/client/validateDOMNesting.js which carries the following copyright:
...
// : AncestorInfo
let validateDOMNesting = (childTag, childText, ancestorInfo) => { };
let updatedAncestorInfo = (oldInfo, tag) => { };
if (global.__DEV__) {
    ...
    validateDOMNesting = function (childTag, childText, ancestorInfo) {
        ...
        if (childText != null) {
            if (childTag != null) {
                console.warn("validateDOMNesting: when childText is passed, childTag should be null");
            }
            childTag = "#text";
        }
        ...
        if (invalidParent) {
            ...
            console.warn("validateDOMNesting(...): %s cannot appear as a child of <%s>.%s%s%s", tagDisplayName, ancestorTag, whitespaceInfo, info, addendum);
        }
        else {
            console.warn("validateDOMNesting(...): %s cannot appear as a descendant of " + "<%s>.%s", tagDisplayName, ancestorTag, addendum);
        }
    };
}
export { updatedAncestorInfo, validateDOMNesting };
//# sourceMappingURL=validateDOMNesting.js.map