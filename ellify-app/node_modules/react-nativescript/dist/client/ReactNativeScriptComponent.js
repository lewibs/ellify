...
export function setInitialProperties(domElement, tag, rawProps, rootContainerElement, hostContext) {
...
export function setInitialDOMProperties(tag, domElement, rootContainerElement, nextProps, isCustomComponentTag, hostContext) {
...
export function updateDOMProperties(instance, updatePayload, wasCustomComponentTag, isCustomComponentTag, hostContext) {
...
export function updateProperties(instance, updatePayload, type, lastRawProps, nextRawProps, hostContext) {
